...
import "./style.css";
  ...
  let who = ["Lovce is", "Your finances are", "Your health is", "Your Spirituality is"];
  let action = ["looking up", "stagnate", "looking down"];
  let what = ["but stay true to your path.", "but don't loose focus on your goals.", "and good fortune is around the corner, but be ready for an new adventure."];
